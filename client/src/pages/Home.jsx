...
const Home = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto flex gap-6 px-4 pb-16 pt-2">
      {/* ════════ MAIN FEED ════════ */}
      ...
      {/* ════════ SIDEBAR ════════ */}
      <aside className="hidden lg:flex flex-col gap-4 w-[252px] shrink-0 pt-0">
        {/* ── Create card ── */}
        <div className="bg-card border border-border/50 rounded-2xl p-4 space-y-3 shadow-sm">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-lg bg-foreground text-background flex items-center justify-center font-black text-[13px]">
              D
            </div>
