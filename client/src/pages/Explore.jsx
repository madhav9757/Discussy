    ...
    <div className="max-w-6xl mx-auto px-4 pb-16 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <aside className="lg:col-span-4 space-y-6">
          ...
          {/* Popular Hubs */}
          <div className="border border-border/40 rounded-xl bg-card p-4 space-y-4 shadow-xs">
          ...
          {/* New & Rising */}
          <div className="border border-border/40 rounded-xl bg-muted/10 p-4 space-y-4">
            ...
            <div className="space-y-3.5">
              {newLoading ? (
                ...
                newCommunities?.slice(0, 3).map((community) => (
                  <Link key={community._id} to={`/communities/${community._id}`} className="flex items-center gap-3 group">
            ...
            <div className="space-y-3.5">
              {creatorsLoading ? (
                ...
                topCreators?.slice(0, 5).map((creator) => (
                  <Link key={creator.user?._id} to={`/profile/${creator.user?._id}`} className="flex items-center gap-3 group">
